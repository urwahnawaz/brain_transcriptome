...
```{r}
 md.summary = dataset_annot[,c(6,4,3,5,1,2)] %>% t() %>%
...
UpSetR::upset(fromList(x), sets.bar.color = c ("#75C7A0","#E11F28","#7DA1D4","#F1605F", "#49215F"))
```
